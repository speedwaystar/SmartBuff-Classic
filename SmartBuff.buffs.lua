...
function SMARTBUFF_InitItemList()
  ...
  -- Stones and oils
  SMARTBUFF_SOULSTONEM          = GetItemInfo(5232);  --"Minor Soulstone"
...
function SMARTBUFF_InitSpellIDs()
  ...
  SMARTBUFF_CREATESSM       = GetSpellInfo(693);   --"Create Soulstone (Minor)"
  ...
  -- Paladin chained
  S.ChainPaladinBlessing = { SMARTBUFF_BOK, SMARTBUFF_GBOK, SMARTBUFF_BOM, SMARTBUFF_GBOM, SMARTBUFF_BOW, SMARTBUFF_GBOW, SMARTBUFF_BOSAL, SMARTBUFF_BOSAN, SMARTBUFF_GBOSAN, SMARTBUFF_BOF, SMARTBUFF_BOP };
...
function SMARTBUFF_InitSpellList()
  ...
  if (SMARTBUFF_PLAYERCLASS == "WARLOCK") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_CREATESSM, 0.03, SMARTBUFF_CONST_ITEM, nil, SMARTBUFF_SOULSTONEM},
